...
<div class="ui grid">
    ...
    <div id="dtop" class="sixteen wide column">
        ...
        <div id="d3" class="ui blue compact menu">
            <a href="/trafo-dashboard.php" id="a1" class="item active">CDM-DASHBOARD</a>
            <a href="/rank.php" id="a1" class="item">ACCOUNT RANKING</a>
        </div>
    </div>
    <!--Right side of page which is loading as per navigation-->
    <div id="dbottom" class="sixteen wide column"><?php include('includes/dmindex.php');?></div>
</div>
