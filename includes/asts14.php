...
<head>
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var options = {
                ...
                subtitle: {
                    text: 'Fiscal Year 2014 Product/AS/TS view',
                    x: -20
                },
                xAxis: {
                    categories: ['']
            ...
            $.getJSON("includes/asts14data.php", function(json)
            {
                var len = json.length;
                for(i=0;i<len;i++){
                    if(i===0){
    ...
    <!-- DataTables -->
    <script type="text/javascript" charset="utf8" src="../js/asts14table.js"></script>
</head>
<body>
